...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { category_id: @menu_item.category_id, description: @menu_item.description, name: @menu_item.name, price: @menu_item.price, sort: @menu_item.sort }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { category_id: @menu_item.category_id, description: @menu_item.description, name: @menu_item.name, price: @menu_item.price, sort: @menu_item.sort }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
